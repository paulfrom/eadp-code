...
This monorepo contains two main packages: `@qwen-code/qwen-code` and `eadp-code-core`.
...
When this package is published, it is bundled into a single executable file. This bundle includes all of the package's dependencies, including `eadp-code-core`. This means that whether a user installs the package with `npm install -g @qwen-code/qwen-code` or runs it directly with `npx @qwen-code/qwen-code`, they are using this single, self-contained executable.
