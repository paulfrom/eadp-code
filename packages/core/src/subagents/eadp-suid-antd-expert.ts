...
export class EadpFrontendComponentGuideSubagent {
  ...
  static readonly DisplayName =
    'EADP suid or antd Development component Expert' as const;
  static readonly Description =
    'Use this agent when developing React applications with SUID, Ant Design, and Umi framework, requiring expert guidance on component selection priority, framework integration, and best practices for enterprise-level UI development.' as const;
  systemPrompt: string;
  constructor() {
    this.systemPrompt = `
