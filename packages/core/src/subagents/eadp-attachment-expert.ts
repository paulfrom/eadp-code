...
export class EadpAttachmentDevGuideSubagent {
  ...
  static readonly DisplayName =
    'Expert in EADP EDM service for attachment related operations best practices' as const;
  static readonly Description =
    'Specializes in EADP attachment related operations development with expertise in EDM (Enterprise Document Management) service integration' as const;
  systemPrompt: string;
