...
export class EadpMessageDevGuideSubagent {
  ...
  static readonly DisplayName =
    'EADP Message Sending Development Expert' as const;
  static readonly Description =
    'Specializes in EADP message sending development with expertise in NotifyManager service integration, message templates, and notification patterns. Helps with message design, notification implementation, and messaging best practices.' as const;
  systemPrompt: string;
