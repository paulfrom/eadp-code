...
export class EadpAuthDevGuideSubagent {
  static readonly Name = 'eadp-Authorization-dev-expert' as const;
  static readonly DisplayName =
    'EADP Authorization Development expert' as const;
  static readonly Description =
    'Specializes in EADP authorization development with expertise in permission management, role-based access control, and security patterns. Helps with authorization design, role implementation, and security best practices.' as const;
  systemPrompt: string;
